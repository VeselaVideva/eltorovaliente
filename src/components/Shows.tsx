...
import { Timeline, Text, Container, Grid, Space, Anchor, SimpleGrid } from '@mantine/core';
        ...
        <Container size="xl">
            ...
            <SimpleGrid cols={3} breakpoints={[{ maxWidth: 'sm', cols: 1 }]}>
                <Timeline active={-1} bulletSize={36} lineWidth={1} align="left">
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CAC The DOG Show – Parvomay, BULGARIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="Amstaff Major 2022 - Szilvasvarad, HUNGARY">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="Royal Cup AST Speciality - Kraljevo, SERBIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CAC - Kraljevo, SERBIA">
                        <Text color="dimmed" size="md">30.04.2022 - Junior class</Text>
                        <Text color="dimmed" size="md">Excellent 2, R.JCAC</Text>
                        <Text color="dimmed" size="md">Judge: Peter Lauber (Switzerland)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB - Vranje, SERBIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB - Niš, SERBIA">
                        <Text color="dimmed" size="md">08.05.2022 - Junior class</Text>
                        <Text color="dimmed" size="md">Excellent 1, JCAC, JBOB</Text>
                        <Text color="dimmed" size="md">Judge: Dragan Krstić (Serbia)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="Naissa Terrier Show AST Speciality - Niš, SERBIA">
                        <Text color="dimmed" size="md">08.05.2022 - Junior class</Text>
                        <Text color="dimmed" size="md">Excellent 3</Text>
                        <Text color="dimmed" size="md">Judge: Alin Dumitrescu (Romania)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB - Skopje, NORTH MACEDONIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CAC - Skopje, NORTH MACEDONIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB - Thessaloniki, GREECE">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CAC - Thessaloniki, GREECE">
                        <Text color="dimmed" size="md">19.06.2022 - Junior class</Text>
                        <Text color="dimmed" size="md">Excellent 1, JCAC, JBOB, BOS</Text>
                ...
                <Timeline active={-1} bulletSize={36} lineWidth={1} align="left">
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CAC – Ploiesti, ROMANIA">
                        <Text color="dimmed" size="md">16.07.2022 - Junior class</Text>
                        <Text color="dimmed" size="md">Excellent 2, R.JCAC</Text>
                        <Text color="dimmed" size="md">Judge: Jeff Horswell (United Kingdom)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB – Ploiesti, ROMANIA">
                        <Text color="dimmed" size="md">16.07.2022 - Junior class</Text>
                        <Text color="dimmed" size="md">Excellent 2, R.JCAC</Text>
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="NDS – Plovdiv, BULGARIA">
                ...
                <Timeline active={-1} bulletSize={36} lineWidth={1} align="left">
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="Amstaff Major 14th – Andrevlje, SERBIA">
                        <Text color="dimmed" size="md">29.04.2023 - Open class</Text>
                        <Text color="dimmed" size="md">Very good</Text>
                        <Text color="dimmed" size="md">Judge: Olaf Verhorevoort (Netherlands)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="Amstaff Major 15th – Andrevlje, SERBIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="XIII DERBY AST Speciality – Indjija, SERBIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="10-breed EDS – Budapest, HUNGARY">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="Karakan Club Show – Budapest, HUNGARY">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CAC – Pirot, SERBIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CAC – Aleksinac, SERBIA">
                    ...
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB – Sokobanja, SERBIA">
                        <Text color="dimmed" size="md">22.07.2023 - Open class</Text>
                        <Text color="dimmed" size="md">Excellent 2, R.CAC, R.CACIB</Text>
                        <Text color="dimmed" size="md">Judge: Marija Radovanović (Serbia)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB – Ohrid, NORTH MACEDONIA">
                        <Text color="dimmed" size="md">31.08.2023 - ... class</Text>
                        <Text color="dimmed" size="md">...</Text>
                        <Text color="dimmed" size="md">Judge: ... (...)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB – Ohrid, NORTH MACEDONIA">
                        <Text color="dimmed" size="md">01.09.2023 - ... class</Text>
                        <Text color="dimmed" size="md">...</Text>
                        <Text color="dimmed" size="md">Judge: ... (...)</Text>
                    </Timeline.Item>
                    <Timeline.Item bullet={<IconTrophy size={18}/>} title="CACIB – Chalkidiki, GREECE">
